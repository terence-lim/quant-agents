...
3. `print(result_panel.as_payload())` (or JSON) so caller receives resulting panel id of persisted output
...
## Example 3 — Rolling time-series statistic with `trend()` (by stock over time)
