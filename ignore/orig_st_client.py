...
@manager_agent.tool
#async
def performance_agent_tool(ctx: RunContext, query: str) -> str:
    """
...
@manager_agent.tool
#async
def factor_agent_tool(ctx: RunContext, query: str) -> str:
    """
...
@manager_agent.tool
#async
def planner_agent_tool(ctx: RunContext, query: str) -> str:
